...
class Ui_Frame_Etape2(object):
    def setupUi(self, Frame):
        ...
        self.checkBox_thoracique = QtWidgets.QCheckBox(self.frame_haut)
        self.checkBox_thoracique.setGeometry(QtCore.QRect(120, 50, 91, 17))
        self.checkBox_thoracique.setObjectName("checkBox_thoracique")
        self.checkBox_dorsale = QtWidgets.QCheckBox(self.frame_haut)
        self.checkBox_dorsale.setGeometry(QtCore.QRect(220, 50, 91, 17))
    ...
    def retranslateUi(self, Frame):
        ...
        self.checkBox_thoracique.setText(_translate("Frame", "Thoracique"))
