...
class Ui_Frame_Oncologie(object):
    def setupUi(self, Frame):
        ...
        self.gridLayout_2.addWidget(self.checkBox_radiculaire, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.checkBox_medullaire, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.checkBox_radicoMedullaire, 1, 0, 1, 1)
        self.checkBox_non = QtWidgets.QCheckBox(self.groupBox_finaliteNeurologique)
        self.checkBox_non.setObjectName("checkBox_non")
        self.gridLayout_2.addWidget(self.checkBox_non, 1, 1, 1, 1)
