...
class Ui_Frame_CreationDP(object):
    def setupUi(self, Frame):
        ...
        self.lineEdit_intervention = QtWidgets.QLineEdit(Frame)
        self.lineEdit_intervention.setGeometry(QtCore.QRect(270, 410, 271, 20))
        self.lineEdit_intervention.setObjectName("lineEdit")
