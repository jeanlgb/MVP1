...
class Ui_Frame_Degeneratif(object):
    def setupUi(self, Frame):
        ...
        self.label_FN.setGeometry(QtCore.QRect(720, 60, 2, 2))
        ...
        self.label_Niveau_massacre.setGeometry(QtCore.QRect(720, 70, 2, 2))
        ...
        self.label_recalibrage_massacre = QtWidgets.QLabel(self.groupBox_recalibrage)
        self.label_recalibrage_massacre.setEnabled(False)
        self.label_recalibrage_massacre.setGeometry(QtCore.QRect(710, 50, 2, 2))
        self.label_recalibrage_massacre.setText("")
        self.label_recalibrage_massacre.setObjectName("label_recalibrage_massacre")
        ...
        self.label_cote = QtWidgets.QLabel(self.groupBox_cote)
        self.label_cote.setEnabled(False)
        self.label_cote.setGeometry(QtCore.QRect(670, 30, 2, 2))
        self.label_cote.setText("")
        self.label_cote.setObjectName("label_cote")
        ...
        self.label_athro_massacre = QtWidgets.QLabel(self.groupBox_arthrodese)
        self.label_athro_massacre.setGeometry(QtCore.QRect(670, 40, 2, 2))
        self.label_athro_massacre.setText("")
        self.label_athro_massacre.setObjectName("label_athro_massacre")
